...
const formFields = [
  { key: 'user_id', label: '接收者 AstrBot ID', type: 'number', required: true, placeholder: '请输入接收者 AstrBot ID' },
...
const searchFields = [
  { key: 'user_display_id', label: '接收者 AstrBot ID', placeholder: '搜索接收者 AstrBot ID' },
  {
    key: 'type',
    label: '通知类型',
    type: 'select',
